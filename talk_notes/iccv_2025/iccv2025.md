...
## Misc
- [Set-of-Mark Prompting Unleashes Extraordinary Visual Grounding in GPT-4V](https://arxiv.org/abs/2310.11441) [Set of mark prompting]


# Multimodal
## Scaling Laws for Native Multimodal Models
- from Apple
- Late fusion vs early fusions
- Scaling laws are similar
- Early fusion requires less parameters
- Sparsity benefits from early fusion more

## Differentiable Room Acoustic Rendering with Multi-View Vision Priors
- Audio-visual differentiable accoustic render framework 
- Emergent behavior of accoustic reflection properties based on materials


## Token Activation Map to Visually Explain Multimodal LLMs
- Yi Li, HKUST
- CAM used for CNN/ViT, soingle class output


## Imaging the black hole
- EHT: evenrt horizon telescope
- Good with science and people, great speaker
- Gravity is a deformation of spacetime


## RayZer --> This is a great paper
- DUST3R, VGGT
- Self-supervised learning for 3d
- Masked token, masked patches --> masked view for 3D
- zero 3D supervision
- COLMAP is not Oracle. Your model could be a distallation of a noisy method
- Similar to video gen models philosophically
- How to scale and also 3D aware
...
- Better blending
- Alexander Mai
- NeRF: bring volumne rendering to neural rendering
- EVER: bring splatting to neural rendering
- 3DGS has the popping effert. EVER stops the popping.


## Dynamic bundle adjustment
- From discarding to exploit motion
- Two methods
	- Treat dynamic as outliers
	- Moiton modeling --> insufficient
- Motion decouling
	- Cemerar motion, object motion
- Only use camera induced motion for BA

## SceneSplt: Gaussian splatting with semantic pretraining 
- generalizable,feed forward 3DGS ecnoder that oeprats natively on 3DGS and unlocks rick semantic learning
- Vision language pretrain in the CLIP style